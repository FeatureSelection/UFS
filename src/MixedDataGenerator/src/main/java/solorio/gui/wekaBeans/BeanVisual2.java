...
/**
 * BeanVisual2 encapsulates icons and label for a given bean. Has methods to load
 ...
 * @see Serializable
 */
public class BeanVisual2 extends JPanel {
   ...
   */
  public BeanVisual2(String visualName, String iconPath, String animatedIconPath) {
  ...
  /**
   * Reduce this BeanVisual2's icon size by the given factor
   * 
