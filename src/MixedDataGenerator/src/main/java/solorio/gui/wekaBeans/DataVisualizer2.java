 ...
 */
public class DataVisualizer2 extends JPanel implements DataSourceListener,
    ...
    protected BeanVisual2 m_visual = new BeanVisual2("DataVisualizer",
            BeanVisual2.ICON_PATH + "DefaultDataVisualizer.gif", BeanVisual2.ICON_PATH
     ...
     * to prevent sending ImageEvents to listeners a second time (since these
     * will have been passed on during headless execution).
     */
    ...
    /**
     * The name of the attribute to use for the x-axis of offscreen plots. If
     * left empty, False Positive Rate is used for threshold curves
     */
    protected String m_xAxis = "";

    /**
     * The name of the attribute to use for the y-axis of offscreen plots. If
     * left empty, True Positive Rate is used for threshold curves
     */
    ...
    /**
     * Process a list of events that have been collected earlier. Has no affect
     * if the component is running in headless mode.
     *
     ...
     */
    @Override
    public void setVisual(BeanVisual2 newVisual) {
        m_visual = newVisual;
    }
    ...
    public void useDefaultVisual() {
        m_visual.loadIcons(BeanVisual2.ICON_PATH + "DefaultDataVisualizer.gif",
                BeanVisual2.ICON_PATH + "DefaultDataVisualizer_animated.gif");
    }
    ...
    /**
     * Returns true if, at this time, the object will accept a connection via
     * the supplied EventSetDescriptor
     *
     ...
     * source for recieving events described by the named event This object is
     ...
     * source for named event. This object is responsible for recording this
     * fact.
     *
     * @param eventName the event
     * @param source the source with which this object has been registered as a
